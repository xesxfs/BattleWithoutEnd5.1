...
(function (iData) {
    var iSkill;
    (function (iSkill) {
        var SkillDataList = (function () {
            function SkillDataList() {
            }
            SkillDataList.behave_smash = function (param1) {
                //这里
                var _loc2_ = param1.skillData.setList;
                var _loc3_ = iData.iSkill.SkillDataList.getCritMul();
                var _loc4_ = (iGlobal.Player.attack * _loc3_ * _loc2_[param1.level] / 100 - iData.iSkill.SkillDataList.monster.defence) * iData.iSkill.SkillDataList.monsterPro;
                if (_loc4_ < 1) {
                    _loc4_ = 1;
                }
            ...
            SkillDataList.behave_life_drain = function (param1) {
                //这里
                var _loc2_ = param1.skillData.setList;
                ...
                var critMul = iData.iSkill.SkillDataList.getCritMul();
                var monlostHp = (iGlobal.Player.attack * critMul * (1 + _loc2_[param1.level][1] * iGlobal.Player.str) - iData.iSkill.SkillDataList.monster.defence) * iData.iSkill.SkillDataList.monsterPro;
                if (monlostHp < 1) {
                    monlostHp = 1;
                }
                MainScene.battle.monsterHp = MainScene.battle.monsterHp - monlostHp;
                var lostHp = monlostHp * _loc2_[param1.level][2] / 100;
            ...
            SkillDataList.behave_defence = function (param1) {
                //这里
                var _loc2_ = param1.skillData.setList;
                var _loc3_ = iData.iSkill.SkillDataList.monster.crit - iGlobal.Player.protection * 2;
                ...
                var _loc5_ = (iData.iSkill.SkillDataList.monster.attack * _loc4_ - iGlobal.Player.defence - _loc2_[param1.level][0]) * (1 - iData.iSkill.SkillDataList.caculateProtection(iGlobal.Player.protection * _loc2_[param1.level][2] + _loc2_[param1.level][1]));
                if (_loc5_ < 1) {
                    _loc5_ = 1;
                }
            ...
            SkillDataList.behave_mana_shield = function (param1) {
                var _loc2_ = param1.skillData.setList;
                if (MainScene.battle.playerMp < _loc2_[param1.level][0]) {
                    return false;
                }
                ...
                var _loc5_ = (iData.iSkill.SkillDataList.monster.attack * _loc4_ - iGlobal.Player.defence) * (1 - iData.iSkill.SkillDataList.caculateProtection(iGlobal.Player.protection));
                var _loc6_ = _loc5_ * _loc2_[param1.level][3] / 100;
                _loc5_ = _loc5_ - _loc6_;
                if (_loc5_ < 1) {
                    _loc5_ = 1;
                }
                MainScene.battle.playerHp = MainScene.battle.playerHp - _loc5_;
                var _loc7_ = _loc6_ / (_loc2_[param1.level][2] + iGlobal.Player.intelligence * _loc2_[param1.level][1]);
            ...
            SkillDataList.behave_counterattack = function (param1) {
                var _loc2_ = param1.skillData.setList;
                var _loc3_ = iData.iSkill.SkillDataList.monster.crit - iGlobal.Player.protection * 2;
                if (_loc3_ > iData.iSkill.SkillDataList.CR) {
                    _loc3_ = iData.iSkill.SkillDataList.CR;
            ...
            SkillDataList.behave_bolt = function (param1) {
                var _loc2_ = param1.skillData.setList;
                ...
                var _loc3_ = iData.iSkill.SkillDataList.getCritMul();
                var _loc4_ = Tool.MyMath.balanceRandom(iGlobal.Player.magicBalance) * (_loc2_[param1.level][1] - _loc2_[param1.level][0]) + _loc2_[param1.level][0];
                var _loc5_ = _loc4_ * _loc3_ * (100 + iGlobal.Player.magicDamage) / 100 * iData.iSkill.SkillDataList.monsterPro;
                if (_loc5_ < 1) {
                    _loc5_ = 1;
                }
            ...
            SkillDataList.behave_thunder = function (param1) {
                var _loc2_ = param1.skillData.setList;
                if (MainScene.battle.playerMp < _loc2_[param1.level][2]) {
                    return false;
                }
                MainScene.battle.playerMp = MainScene.battle.playerMp - _loc2_[param1.level][2];
                var _loc3_ = iData.iSkill.SkillDataList.getCritMul(_loc2_[param1.level][3]);
                var _loc4_ = Tool.MyMath.balanceRandom(iGlobal.Player.magicBalance) * (_loc2_[param1.level][1] - _loc2_[param1.level][0]) + _loc2_[param1.level][0];
                var _loc5_ = _loc4_ * _loc3_ * (100 + iGlobal.Player.magicDamage) / 100 * (1 - iData.iSkill.SkillDataList.caculateProtection(iData.iSkill.SkillDataList.monster.protection - iGlobal.Player.protectionReduce - iGlobal.Player.protectionIgnore - _loc2_[param1.level][3] - iGlobal.Player.will * _loc2_[param1.level][4]));
                if (_loc5_ < 1) {
                    _loc5_ = 1;
                }
                MainScene.battle.monsterHp = MainScene.battle.monsterHp - _loc5_;
            ...
            SkillDataList.behave_fireball = function (param1) {
                var _loc2_ = param1.skillData.setList;
                if (MainScene.battle.playerMp < _loc2_[param1.level][2]) {
                    return false;
                }
            ...
            SkillDataList.behave_ice_spear = function (param1) {
                var _loc2_ = param1.skillData.setList;
                if (MainScene.battle.playerMp < _loc2_[param1.level][2]) {
                    return false;
                }
                ...
                var _loc3_ = iData.iSkill.SkillDataList.getCritMul();
                var _loc4_ = Tool.MyMath.balanceRandom(iGlobal.Player.magicBalance) * (_loc2_[param1.level][1] - _loc2_[param1.level][0]) + _loc2_[param1.level][0];
                var _loc5_ = (Tool.MyMath.balanceRandom(iGlobal.Player.magicBalance) * (_loc2_[param1.level][1] - _loc2_[param1.level][0]) + _loc2_[param1.level][0]) * _loc3_ * (100 + iGlobal.Player.magicDamage) / 100 * iData.iSkill.SkillDataList.monsterPro;
                if (_loc5_ < 1) {
                    _loc5_ = 1;
                }
                MainScene.battle.monsterHp = MainScene.battle.monsterHp - _loc5_;
            ...
            SkillDataList.behave_mirage_missle = function (param1) {
                var _loc2_ = param1.skillData.setList;
                if (MainScene.battle.playerMp < _loc2_[param1.level][2]) {
                    return false;
                }
                MainScene.battle.playerMp = MainScene.battle.playerMp - _loc2_[param1.level][2];
                var _loc3_ = iData.iSkill.SkillDataList.getCritMul();
                var _loc4_ = (iGlobal.Player.attack * _loc3_ * _loc2_[param1.level][0] / 100 - iData.iSkill.SkillDataList.monster.defence) * iData.iSkill.SkillDataList.monsterPro;
                if (_loc4_ < 1) {
                    _loc4_ = 1;
                }
                MainScene.battle.monsterHp = MainScene.battle.monsterHp - _loc4_;
            ...
            SkillDataList.behave_corrosive_shot = function (param1) {
                var _loc2_ = param1.skillData.setList;
                if (MainScene.battle.playerMp < _loc2_[param1.level][2]) {
                    return false;
                }
                MainScene.battle.playerMp = MainScene.battle.playerMp - _loc2_[param1.level][2];
                var _loc3_ = iData.iSkill.SkillDataList.getCritMul();
                var _loc4_ = (iGlobal.Player.attack * _loc3_ * (_loc2_[param1.level][0] / 100 + iGlobal.Player.dex * _loc2_[param1.level][4] / 100) - iData.iSkill.SkillDataList.monster.defence) * iData.iSkill.SkillDataList.monsterPro;
                if (_loc4_ < 1) {
                    _loc4_ = 1;
                }
                MainScene.battle.monsterHp = MainScene.battle.monsterHp - _loc4_;
            ...
            SkillDataList.traceAttackInfo = function (param1, param2, param3) {
                if (param3 > 1) {
            ...
            Object.defineProperty(SkillDataList, "monster", {
                get: function () {
            ...
            Object.defineProperty(SkillDataList, "CR", {
                get: function () {
            ...
            Object.defineProperty(SkillDataList, "monsterPro", {
                get: function () {
            ...
            SkillDataList.caculateProtection = function (param1) {
                param1 = param1;
                if (param1 >= 0) {
            ...
            SkillDataList.getCritMul = function (param1) {
                if (param1 === void 0) { param1 = 0; }
                var _loc2_ = iGlobal.Player.crit - (iData.iSkill.SkillDataList.monster.protection - iGlobal.Player.protectionReduce) * 2;
            ...
            SkillDataList.des_combat_master = function (param1) {
                var _loc2_ = iData.iSkill.SkillDataList.getTitle(param1);
            ...
            SkillDataList.des_blacksmithing = function (param1) {
                var _loc4_ = null;
                var _loc2_ = iData.iSkill.SkillDataList.getTitle(param1);
                var _loc3_ = param1.level;
            ...
            SkillDataList.des_defence = function (param1) {
                var _loc2_ = param1.skillData.setList;
                var _loc3_ = iData.iSkill.SkillDataList.getTitle(param1);
            ...
            SkillDataList.des_counterattack = function (param1) {
                var _loc2_ = param1.skillData.setList;
                var _loc3_ = iData.iSkill.SkillDataList.getTitle(param1);
            ...
            SkillDataList.des_smash = function (param1) {
                var _loc2_ = param1.skillData.setList;
                var _loc3_ = iData.iSkill.SkillDataList.getTitle(param1);
                _loc3_ = _loc3_ + "<font size=\'20\'>当技能使用成功时:<br/>";
            ...
            SkillDataList.des_magic_bolt = function (param1) {
                var _loc2_ = param1.skillData;
                var _loc3_ = iData.iSkill.SkillDataList.getTitle(param1);
            ...
            SkillDataList.des_fireball = function (param1) {
                var _loc2_ = param1.skillData;
                var _loc3_ = iData.iSkill.SkillDataList.getTitle(param1);
                _loc3_ = _loc3_ + ("<font size=\'20\'>  伤害:" + _loc2_.setList[param1.level][0] + "~" + _loc2_.setList[param1.level][1] + "<br/>");
            ...
            SkillDataList.des_icespear = function (param1) {
                var _loc2_ = param1.skillData;
                var _loc3_ = iData.iSkill.SkillDataList.getTitle(param1);
                _loc3_ = _loc3_ + ("<font size=\'20\'>  伤害:" + _loc2_.setList[param1.level][0] + "~" + _loc2_.setList[param1.level][1] + "<br/>");
            ...
            SkillDataList.des_thunder = function (param1) {
                var _loc2_ = param1.skillData;
                var _loc3_ = iData.iSkill.SkillDataList.getTitle(param1);
                _loc3_ = _loc3_ + ("<font size=\'20\'>  伤害:" + _loc2_.setList[param1.level][0] + "~" + _loc2_.setList[param1.level][1] + "<br/>");
            ...
            SkillDataList.des_mana_shield = function (param1) {
                var _loc2_ = param1.skillData;
                var _loc3_ = iData.iSkill.SkillDataList.getTitle(param1);
                _loc3_ = _loc3_ + "<font size=\'20\'>";
            ...
            SkillDataList.des_mirage_missle = function (param1) {
                var _loc2_ = param1.skillData;
                var _loc3_ = iData.iSkill.SkillDataList.getTitle(param1);
            ...
            SkillDataList.des_corrosive_shot = function (param1) {
                var _loc2_ = param1.skillData;
                var _loc3_ = iData.iSkill.SkillDataList.getTitle(param1);
            ...
            SkillDataList.des_life_drain = function (param1) {
                var _loc2_ = param1.skillData;
                var _loc3_ = iData.iSkill.SkillDataList.getTitle(param1);
            ...
            SkillDataList.getTitle = function (param1) {
                var _loc2_ = "<p align=\'center\'>" + param1.skillData.realName + " " + (15 - param1.level).toString(16).toUpperCase() + "</p>";
                _loc2_ = _loc2_ + ("<p align=\'center\'><font size=\'16\'>" + iData.iSkill.SkillDataList.getCategory(param1) + "</font></p>");
                return _loc2_;
            };
            SkillDataList.getCategory = function (param1) {
            ...
            SkillDataList.getStat = function (param1, param2) {
                param2 = param2;
                var _loc3_ = "";
                _loc3_ = _loc3_ + "<font size=\'20\'>";
                var _loc4_ = param1.skillData.statList[param2];
                var i = 0;
            ...
            SkillDataList.getEffect = function (param1, param2) {
                var _loc4_ = null;
                var _loc5_ = 0;
                var _loc3_ = "<font size=\'20\'>";
            ...
            SkillDataList.getAp = function (param1, param2) {
                var _loc3_ = "<font size=\'24\'>";
        ...
        iSkill.SkillDataList = SkillDataList;
        __reflect(SkillDataList.prototype, "iData.iSkill.SkillDataList");
...
iData.iSkill.SkillDataList.SMASH = new iData.iSkill.ActiveSkillData("Smash", "重击", iData.iSkill.SkillType.ATTACK, iData.iSkill.SkillCategory.MELEE, [new Array(0), new Array(0), new Array(0), new Array(0), new Array(0), new Array(0), new Array(0), [new iData.iItem.Stat(iData.iItem.Stat.str, 1), new iData.iItem.Stat(iData.iItem.Stat.will, 1)], [new iData.iItem.Stat(iData.iItem.Stat.str, 2), new iData.iItem.Stat(iData.iItem.Stat.will, 2)], [new iData.iItem.Stat(iData.iItem.Stat.str, 3), new iData.iItem.Stat(iData.iItem.Stat.will, 3)], [new iData.iItem.Stat(iData.iItem.Stat.str, 4), new iData.iItem.Stat(iData.iItem.Stat.will, 4)], [new iData.iItem.Stat(iData.iItem.Stat.str, 5), new iData.iItem.Stat(iData.iItem.Stat.will, 5)], [new iData.iItem.Stat(iData.iItem.Stat.str, 6), new iData.iItem.Stat(iData.iItem.Stat.will, 6)], [new iData.iItem.Stat(iData.iItem.Stat.str, 7), new iData.iItem.Stat(iData.iItem.Stat.will, 7)], [new iData.iItem.Stat(iData.iItem.Stat.str, 8), new iData.iItem.Stat(iData.iItem.Stat.will, 8)]], null, [0, 2, 4, 6, 8, 10, 11, 11, 11, 11, 13, 13, 13, 13, 20], [200, 210, 220, 230, 240, 250, 300, 310, 320, 330, 400, 420, 440, 460, 500], iData.iSkill.SkillDataList.des_smash, iData.iSkill.SkillDataList.behave_smash);
