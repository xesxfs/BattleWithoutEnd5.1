...
(function (iData) {
    var iPet;
    (function (iPet) {
        var PetDataList = (function (_super) {
            __extends(PetDataList, _super);
            function PetDataList() {
                return _super.call(this) || this;
            }
            return PetDataList;
        }(egret.HashObject));
        iPet.PetDataList = PetDataList;
        __reflect(PetDataList.prototype, "iData.iPet.PetDataList");
