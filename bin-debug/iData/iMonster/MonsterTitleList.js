...
(function (iData) {
    var iMonster;
    (function (iMonster) {
        var MonsterTitleList = (function () {
            function MonsterTitleList() {
            }
            return MonsterTitleList;
        }());
        iMonster.MonsterTitleList = MonsterTitleList;
        __reflect(MonsterTitleList.prototype, "iData.iMonster.MonsterTitleList");
...
iData.iMonster.MonsterTitleList.list = [
    ...
    new iData.iMonster.MonsterTitle("可疑的", new Array(0), 3, 3, 3),
