...
var SystemWindow = (function (_super) {
    ...
    function SystemWindow() {
        ...
        _this.gapX = 70;
        _this.gapBigY = 60;
        _this.fontSize_small = 24;
        _this.fontSize_meddle = 28;
        _this.fontSize_big = 32;
        _this.lootStartX = 20;
        _this.lootStartY = 140;
        _this.lootGapSmallY = 32;
        _this.lootGapY = 34;
        _this.lootGapMidY = 42;
        _this.lootGapBitY = 75;
        _this.lootGapX = 120;
        var bgs = new BasicCell(390, 750);
        _this.addChild(bgs);
        _this.init();
        return _this;
    }
    ...
    SystemWindow.prototype.autoSell = function () {
        ...
        var autoSell = new ToggleBox("背包满时自动卖出价值最低", 22, iGlobal.Global.autoSell_toggle);
