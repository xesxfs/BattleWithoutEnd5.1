...
var SpecialShopPanel = (function (_super) {
    ...
    SpecialShopPanel.prototype.init = function () {
        ...
        var title = new StringCell("特殊商店", 300, 54);
        this.addChild(title);
        title.x = 170;
        title.y = 10;
        ...
        var bag_text = new StringCell("背包拓展", 100, 32);
        ...
        var pet_text = new StringCell("宠物拓展", 100, 32);
...
__reflect(SpecialShopPanel.prototype, "SpecialShopPanel");
